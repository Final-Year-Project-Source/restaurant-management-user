...
(exports.id = 329),
  ...
  (exports.modules = {
    12329: (e, t, n) => {
      ...
      function d(e, t) {
        let { assetPrefix: n, buildManifest: i, assetQueryString: o, disableOptimizedLoading: s, crossOrigin: a } = e;
      ...
      function _(e, t) {
        let { scriptLoader: n, disableOptimizedLoading: i, crossOrigin: o } = e,
          ...
          `,
                ...
                r.default.createElement('script', { 'data-partytown': '', dangerouslySetInnerHTML: { __html: e() } }),
                (i.worker || []).map((e, n) => {
              ...
              return (0, a.default)(e) && 'MODULE_NOT_FOUND' !== e.code && console.warn(`Warning: ${e.message}`), null;
            }
          })(e, t),
      ...
      class E extends r.default.Component {
        ...
        getPreloadDynamicChunks() {
          let { dynamicImports: e, assetPrefix: t, assetQueryString: n, crossOrigin: i } = this.context;
          return e
            .map((e) =>
              e.endsWith('.js')
                ? r.default.createElement('link', {
        ...
        getPreloadMainLinks(e) {
          let { assetPrefix: t, assetQueryString: n, scriptLoader: i, crossOrigin: o } = this.context,
        ...
        render() {
          ...
          I &&
            (I.forEach((e) => {
              let t;
              this.context.strictNextHead && (t = r.default.createElement('meta', { name: 'next-head', content: '1' })),
                e && 'link' === e.type && 'preload' === e.props.rel && 'style' === e.props.as
                  ? (t && T.push(t), T.push(e))
                  : e && (t && ('meta' !== e.type || !e.props.charSet) && P.push(t), P.push(e));
            }),
            (I = T.concat(P)));
          let v = r.default.Children.toArray(this.props.children).filter(Boolean);
          ...
          return r.default.createElement(
            ...
            this.context.isDevelopment &&
              r.default.createElement(
                ...
                r.default.createElement(
                  ...
                  r.default.createElement('style', { dangerouslySetInnerHTML: { __html: 'body{display:block}' } }),
                ),
              ),
            I,
            ...
            i &&
              r.default.createElement(
                ...
                !b && r.default.createElement('link', { rel: 'canonical', href: s + n(50733).cleanAmpPath(l) }),
                r.default.createElement('link', {
                  rel: 'preload',
                  as: 'script',
                ...
                r.default.createElement('script', { async: !0, src: 'https://cdn.ampproject.org/v0.js' }),
              ),
            !i &&
              r.default.createElement(
                r.default.Fragment,
                ...
                m && this.getCssLinks(N),
                m && r.default.createElement('noscript', { 'data-n-css': this.props.nonce ?? '' }),
                this.context.isDevelopment && r.default.createElement('noscript', { id: '__next_css__DO_NOT_USE__' }),
                e || null,
              ),
          ...
          try {
            ...
            return (
              r &&
                ...
                } is ${a(o)} which exceeds the threshold of ${a(r)}, this amount of data can reduce performance.
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
        ...
        return (
          ...
          (function (e, t, n) {
            ...
            let l = [],
              ...
              c = null == (o = u.find((e) => e.type === E)) ? void 0 : null == (i = o.props) ? void 0 : i.children,
              f = null == (a = u.find((e) => 'body' === e.type)) ? void 0 : null == (s = a.props) ? void 0 : s.children,
      ...
      class I extends r.default.Component {
        ...
        render() {
          return r.default.createElement(
            ...
            r.default.createElement('body', null, r.default.createElement(S, null), r.default.createElement(g, null)),
          );
        }
      }
    ...
    96514: (e, t, n) => {
      ...
      function s(e) {
              ...
              : (0, r.ensureLeadingSlash)(e);
        {
          let { posix: e } = n(71017),
            r = e.normalize(t);
          if (r !== t) throw new o.NormalizeError('Requested and resolved page mismatch: ' + t + ' ' + r);
        }
        return t;
      }
    },
    ...
    95955: (e, t) => {
      ...
      let n = ['B', 'kB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB'],
        r = (e, t) => {
          let n = e;
          return 'string' == typeof t ? (n = e.toLocaleString(t)) : !0 === t && (n = e.toLocaleString()), n;
        };
      function i(e, t) {
    ...
    3112: (e, t, n) => {
      e.exports = n(87093).vendored.contexts.HtmlContext;
    },
    75778: (e, t, n) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      function o(e, t) {
        ...
        return e.pages[n] || (console.warn(`Could not find files for ${n} in .next/build-manifest.json`), []);
      }
    },
    79630: (e, t) => {
      Object.defineProperty(t, '__esModule', { value: !0 }),
