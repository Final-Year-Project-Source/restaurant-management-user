  ...
  [8863],
  {
    ...
    11288: function (t, e, n) {
      ...
      var s = n(10870),
        ...
        _ = 'undefined' != typeof MutationObserver,
        b = (function () {
          function t() {
            (this.connected_ = !1),
      ...
      var R = (function () {
                ...
                return (function (t) {
                  ...
                  if (
                    ('border-box' === r.boxSizing &&
                      (Math.round(c + o) !== e && (c -= E(r, 'left', 'right') + o),
                      Math.round(a + s) !== n && (a -= E(r, 'top', 'bottom') + s)),
                    t !== y(t).document.documentElement)
                  ) {
        ...
        k = function (t, e) {
          var n,
            ...
            c =
              ...
              (i = e.width),
              (o = e.height),
              m((s = Object.create(('undefined' != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype)), {
                x: n,
                y: r,
                width: i,
                height: o,
          ...
          return (
            (t.prototype.observe = function (t) {
              ...
              if ('undefined' != typeof Element && Element instanceof Object) {
                if (!(t instanceof y(t).Element)) throw TypeError('parameter 1 is not of type "Element".');
                var e = this.observations_;
                e.has(t) || (e.set(t, new R(t)), this.controller_.addObserver(this), this.controller_.refresh());
              }
            }),
        ...
        x = 'undefined' != typeof WeakMap ? new WeakMap() : new f(),
        T = function t(e) {
          if (!(this instanceof t)) throw TypeError('Cannot call a class as a function.');
          if (!arguments.length) throw TypeError('1 argument required, but only 0 present.');
          var n = new A(e, b.getInstance(), this);
          x.set(this, n);
        };
      ...
      var C = void 0 !== l.ResizeObserver ? l.ResizeObserver : T,
        Z = new Map(),
        z = new C(function (t) {
          t.forEach(function (t) {
            var e,
        ...
        L = i.forwardRef(function (t, e) {
          var n = t.children,
            ...
            l = 'function' == typeof n,
            v = l ? n(o) : n,
            p = i.useRef({ width: -1, height: -1, offsetWidth: -1, offsetHeight: -1 }),
            _ = !l && i.isValidElement(v) && (0, u.Yr)(v),
            b = _ ? v.ref : null,
            m = (0, u.x1)(b, o),
            y = function () {
              var t;
          ...
          var w = i.useCallback(function (t) {
            ...
            if (
              p.current.width !== h ||
              p.current.height !== f ||
              p.current.offsetWidth !== a ||
              p.current.offsetHeight !== u
            ) {
              var l = { width: h, height: f, offsetWidth: a, offsetHeight: u };
              p.current = l;
              var v = (0, s.Z)(
                (0, s.Z)({}, l),
                {},
          ...
          return (
            i.useEffect(
              function () {
                var t = y();
                return (
                  t && !r && (Z.has(t) || (Z.set(t, new Set()), z.observe(t)), Z.get(t).add(w)),
                  function () {
                    Z.has(t) && (Z.get(t).delete(w), Z.get(t).size || (z.unobserve(t), Z.delete(t)));
                  }
                );
              },
              [o.current, r],
            ),
            i.createElement(j, { ref: f }, _ ? i.cloneElement(v, { ref: m }) : v)
          );
        }),
        B = i.forwardRef(function (t, e) {
          ...
          return ('function' == typeof n ? [n] : (0, o.Z)(n)).map(function (n, o) {
            ...
            return i.createElement(L, (0, r.Z)({}, t, { key: s, ref: 0 === o ? e : void 0 }), n);
          });
        });
