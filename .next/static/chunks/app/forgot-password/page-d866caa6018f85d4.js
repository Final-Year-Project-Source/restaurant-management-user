    ...
    48753: function (e, t, n) {
      ...
      function d() {
        ...
        let N = (0, r.jsxs)('div', {
            ...
            children: [
              (0, r.jsx)('div', {
                className: 'text-[24px] font-bold text-black-500 my-3',
              ...
              (0, r.jsxs)('div', {
                className: 'w-full',
                children: [
                  (0, r.jsx)('div', { className: 'text-[14px] font-bold text-black-500 my-3', children: 'Email' }),
              ...
              (0, r.jsxs)('div', {
                ...
                children: [
                  f
                    ? (0, r.jsx)('div', { className: 'text-red-500 text-[14px]', children: f })
              ...
              (0, r.jsx)('div', {
                className: 'text-[14px] text-right text-black-500 cursor-pointer w-full italic hover:underline '.concat(
          ...
          T = (0, r.jsxs)('div', {
            className:
              'flex flex-col bg-white justify-center items-center w-full sm:max-w-xl space-y-3 p-10 rounded-xl shadow-2xl max-[768px]:m-2',
            children: [
              (0, r.jsx)('div', { className: 'text-[24px] font-bold text-black-500 my-3', children: 'Reset Password' }),
              (0, r.jsx)('div', {
                className: 'text-[14px] text-black-500 my-5',
              ...
              (0, r.jsx)('div', {
                className: 'text-[14px] text-black-500 hover:underline cursor-pointer w-full italic '.concat(
                  h && 'pointer-events-none',
                ),
                onClick: () => v(!1),
