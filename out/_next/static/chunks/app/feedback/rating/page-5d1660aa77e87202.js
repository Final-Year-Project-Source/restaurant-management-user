        ...
        p = (e) => {
          ...
          return (0, r.jsxs)('div', {
            ...
            children: [
              ...
              (0, r.jsxs)('div', {
                className: 'text-black-500 text-[18px] text-center mb-[22px]',
                children: [
          ...
          return (
            ...
            (0, r.jsxs)('div', {
              ...
              children: [
                ...
                (0, r.jsx)('div', {
                  className: 'text-black-400 text-[18px] text-center font-medium mb-[7px]',
                  children: 'Help us spread the word',
                }),
                (0, r.jsx)('div', {
                  className: 'text-black-500 text-[13px] text-center mb-[20px] '.concat(u().className),
